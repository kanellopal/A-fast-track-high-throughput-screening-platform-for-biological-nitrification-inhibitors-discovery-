---
title: "AOM inhibition thresholds heatmap and comparison with literature"
...
# Scale the data to reveal the differences
...
cairo_pdf("Figure 4-AOM_EC50s_heatmap_log.pdf", width = 8, height = 4)
...
line_plot_EC50_NMUL <- ggplot(data_NMUL, aes(x = EC50_LBC, y = EC50_FTS)) + geom_point(size = 2) +
  ...
  geom_text(x = 0, y = -150, label = paste("R - squared =", round(linear_regression_EC50$adj.r.squared,4)), colour = "black", size = 5, hjust = 0) +   
  geom_text(x = 0, y = -200, label = paste("Slope =", round(linear_regression_EC50$coefficients[2,1],2)), colour = "black", size = 5, hjust = 0)   
...
line_plot_EC50_log10_NMUL <- ggplot(data_NMUL_log10, aes(x = EC50_LBC, y = EC50_FTS)) + 
  ...
  geom_text(x = 0, y = -0.63, label = paste("R - squared =", round(linear_regression_logEC50$adj.r.squared,4)), colour = "black", size = 5, hjust = 0) +   
  geom_text(x = 0, y = -0.83, label = paste("Slope =", round(linear_regression_logEC50$coefficients[2,1],2)), colour = "black", size = 5, hjust = 0)   
...
patchwork_EC50_compare_NMUL <- (line_plot_EC50_NMUL + line_plot_EC50_log10_NMUL) / EC50_compare_plot_DMPP_NP_NMUL / EC50_compare_plot_EQ_MHPP_SKNT_DD_NMUL + plot_layout(ncol = 1, nrow = 3, heights = c(4,2,3))
...
line_plot_EC50_NF <- ggplot(data_NF, aes(x = EC50_LBC, y = EC50_FTS)) + geom_point(size = 2) +
  ...
  geom_errorbar(aes(xmin = EC50_LBC - SE_LBC, xmax = EC50_LBC + SE_LBC)) + geom_smooth(method = lm, linetype = "dashed", linewidth = 0.6, se = T) + 
  geom_point(aes(colour = Compound)) +   
  geom_text(x = 0, y = -1000, label = paste("R - squared =", round(linear_regression_EC50$adj.r.squared,4)), colour = "black", size = 5, hjust = 0) +   
  geom_text(x = 0, y = -1500, label = paste("Slope =", round(linear_regression_EC50$coefficients[2,1],2)), colour = "black", size = 5, hjust = 0)   
...
line_plot_EC50_log10_NF <- ggplot(data_NF_log10, aes(x = EC50_LBC, y = EC50_FTS)) + 
  ...
  labs(x = "log10 Liquid Batch Cultures EC50 (μM)", y = "log10 Fast - Track System EC50 (μM)") +
  theme(axis.title = element_text(size = 24), axis.text = element_text(size = 20), legend.title = element_text(size = 16), legend.text = element_text(size = 20)) + geom_smooth(method = lm, linetype = "dashed", linewidth = 1, se = T) + geom_point(aes(colour = Compound)) +   
  geom_text(x = 0, y = 0.25, label = paste("R - squared =", round(linear_regression_logEC50$adj.r.squared,4)), colour = "black", size = 5, hjust = 0) +   
  geom_text(x = 0, y = 0, label = paste("Slope =", round(linear_regression_logEC50$coefficients[2,1],2)), colour = "black", size = 5, hjust = 0)   
...
patchwork_EC50_compare_NF <- (line_plot_EC50_NF + line_plot_EC50_log10_NF) / EC50_compare_plot_NP_EQ_SKNT_NF / EC50_compare_plot_MHPP_SKNT_DD_NF + plot_layout(ncol = 1, nrow = 3, heights = c(4,2,3))
...
line_plot_EC50_NVE <- ggplot(data_NVE, aes(x = EC50_LBC, y = EC50_FTS)) + geom_point(size = 2) +
  ...
  geom_errorbar(aes(xmin = EC50_LBC - SE_LBC, xmax = EC50_LBC + SE_LBC)) + geom_smooth(method = lm, linetype = "dashed", linewidth = 0.6, se = T) + 
  geom_point(aes(colour = Compound)) +   
  geom_text(x = 200, y = -1000, label = paste("R - squared =", round(linear_regression_EC50$adj.r.squared,4)), colour = "black", size = 5, hjust = 0) +   
  geom_text(x = 200, y = -1500, label = paste("Slope =", round(linear_regression_EC50$coefficients[2,1],2)), colour = "black", size = 5, hjust = 0)   
...
line_plot_EC50_log10_NVE <- ggplot(data_NVE_log10, aes(x = EC50_LBC, y = EC50_FTS)) + 
  ...
  labs(x = "log10 Liquid Batch Cultures EC50 (μM)", y = "log10 Fast - Track System EC50 (μM)") +
  theme(axis.title = element_text(size = 24), axis.text = element_text(size = 20), legend.title = element_text(size = 16), legend.text = element_text(size = 20)) + geom_smooth(method = lm, linetype = "dashed", linewidth = 1, se = T) + geom_point(aes(colour = Compound)) +   
  geom_text(x = 2, y = 0.8, label = paste("R - squared =", round(linear_regression_logEC50$adj.r.squared,4)), colour = "black", size = 5, hjust = 0) +   
  geom_text(x = 2, y = 0.6, label = paste("Slope =", round(linear_regression_logEC50$coefficients[2,1],2)), colour = "black", size = 5, hjust = 0)   
...
patchwork_EC50_compare_NVE <- (line_plot_EC50_NVE + line_plot_EC50_log10_NVE) / EC50_compare_plot_NP_EQ_SKNT_NVE / EC50_compare_plot_MHPP_SKNT_DD_NVE + plot_layout(ncol = 1, nrow = 3, heights = c(4,2,3))
