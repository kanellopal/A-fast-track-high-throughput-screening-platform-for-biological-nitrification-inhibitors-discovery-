...
The μmax can be found in Supplementary Figure S4C and Supplementary Table S5. The routine culture growth model curve is used in Supplementary Figure S1C  
...
cairo_pdf("Figure S3. NUE_Standardisation.pdf", height = 30, width = 30)
print(patchwork)
dev.off()
```
...
ggsave("Figure S4D-NUE maximum specific growth rate.pdf", plot = line_plot_exponential_ln, device = "pdf", height = 10, width = 10)
