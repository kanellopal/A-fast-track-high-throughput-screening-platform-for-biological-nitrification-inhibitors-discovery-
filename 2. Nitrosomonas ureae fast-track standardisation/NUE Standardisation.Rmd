...
The μmax can be found in Supplementary Table S5.The μmax calculation is shown in Supplementary Figure S4C. The routine culture growth model curve is used in Supplementary Figure S1C  
...
line_plots_DNA <- ggplot(data_1D_DNA_lineplot, aes(x = factor(Step), y = Mean, group = Repetition)) + geom_point(aes(colour = Repetition)) + 
  theme_light() + labs(title = "Nitromonas ureae Cell Density Determination",subtitle = "Comparison between consecutive attempts", x = "Sample", y = "Cell Density (cells/mL)") + 
