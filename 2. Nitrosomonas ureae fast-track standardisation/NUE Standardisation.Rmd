...
The μmax can be found in Supplementary Figure S4C and Supplementary Table S5. The routine culture growth model curve is used in Supplementary Figure S2C  
...
The activity rate can be found in Supplementary Table S5. The fast-track culture activity plot is used in Supplementary Figure S2C  
