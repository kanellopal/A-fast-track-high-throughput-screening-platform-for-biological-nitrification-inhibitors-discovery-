...
box_plot_DNA <- ggplot(data_1D_DNA, aes(x = Step, y = Cells)) + 
  ...
  labs(title = "N. multiformis Cell Density Determination", x = "Sample", y = "Cell Density (cells/mL)") +
...
line_plots_DNA <- ggplot(data_1D_DNA_lineplot, aes(x = factor(Step), y = Mean, group = Repetition)) + geom_point(aes(colour = Repetition)) + 
  theme_light() + labs(title = "Nitrosospira multiformis Cell Density Determination",subtitle = "Comparison between consecutive attempts", x = "Sample", y = "Cell Density (cells/mL)") + 
...
cairo_pdf("Figure S1. NMUL_Standardisation.pdf", height = 30, width = 30)
print(patchwork)
dev.off()
```
